...
const PhantomWallet = () => {
  ...
  // Make handleConnect available globally
  useEffect(() => {
    (window as any).handlePhantomConnect = handleConnect;
  }, []);
      ...
      {isConnected ? (
        ...
        <div className="min-h-screen bg-background relative flex items-center justify-center">
          ...
          <div className="relative z-10">
            <h1 className="text-[120px] sm:text-[180px] font-black text-black/40">FRED</h1>
          </div>
        </div>
      )}
      <Toaster 
